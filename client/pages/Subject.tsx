                        ...
                        <TableCell className="border-r border-gray-200 align-top">
                          <div className="flex flex-col space-y-2 p-2">
                            <Link
                              ...
                              className="inline-flex flex-col items-center px-3 py-2 text-sm font-medium rounded-lg text-blue-700 bg-blue-100 hover:bg-blue-200 transition-colors"
                            >
                            ...
                            <Link
                              ...
                              className="inline-flex flex-col items-center px-3 py-2 text-sm font-medium rounded-lg text-green-700 bg-green-100 hover:bg-green-200 transition-colors"
                            >
                            ...
                            <Link
                              ...
                              className="inline-flex flex-col items-center px-3 py-2 text-sm font-medium rounded-lg text-purple-700 bg-purple-100 hover:bg-purple-200 transition-colors"
                            >
