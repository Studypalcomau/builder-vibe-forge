...
export default function ComprehensiveStudyGuide() {
  ...
  const [studyGuide, setStudyGuide] = useState({
    ...
    examFormat: {
      ...
      structure:
        "Section A: Multiple choice (20 marks), Section B: Extended response (80 marks)",
    },
    units: [
      {
        id: "unit1",
              ...
              workedExamples: [
                {
                  ...
                  examTips:
                    "Always check for square roots, fractions, and logarithms when finding domain",
                },
              ],
              examQuestions: [
                {
                ...
                },
                {
                  ...
                  question:
                    "A parabola has vertex at (-2, 5) and passes through (0, 1). Find the equation in the form f(x) = ax² + bx + c",
                  solutionSteps: [
          ...
          },
          {
            ...
            content: {
              ...
              workedExamples: [
                {
                  question:
                    "Describe the transformations that map f(x) = x² to g(x) = -2(x - 3)² + 1",
                  solution: [
                  ...
                  examTips:
                    "Always state transformations in the correct order of operations",
                },
              ],
              examQuestions: [
                {
                  type: "Extended Response",
                  question:
                    "The graph of y = f(x) is transformed to y = 3f(2x - 4) + 1. Describe the sequence of transformations.",
                  solutionSteps: [
              ...
              workedExamples: [
                {
                  ...
                  examTips:
                    "Always identify the inner and outer functions clearly when using chain rule",
                },
              ],
              examQuestions: [
                {
                  type: "Extended Response",
                  question:
                    "A particle moves along a straight line. Its displacement from the origin at time t seconds is given by s(t) = 2t³ - 9t² + 12t + 1. Find when the particle is momentarily at rest.",
                  solutionSteps: [
              ...
              workedExamples: [
                {
                  ...
                  examTips:
                    "Always show the antiderivative before substituting limits",
                },
              ],
              examQuestions: [
                {
                  type: "Extended Response",
                  question:
                    "The region bounded by y = x², y = 0, x = 1, and x = 3 is rotated about the x-axis. Find the volume of the solid formed.",
                  solutionSteps: [
  ...
  const removeFormula = (unitId: string, topicId: string, index: number) => {
    ...
    const topic = unit?.topics.find((t) => t.id === topicId);
    if (topic) {
      const updatedFormulas = topic.content.keyFormulas.filter(
        (_, i) => i !== index,
      );
      updateSection(unitId, topicId, "keyFormulas", updatedFormulas);
    }
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Detailed exam preparation content with worked examples,
          ...
          <CardContent>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded border">
              ...
              <div className="text-gray-700">
                {studyGuide.examFormat.structure}
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <div key={topic.id} className="mb-8 last:mb-0">
                        ...
                        >
                          {isEditing ? (
                            <div className="flex items-center space-x-2">
                              ...
                              <Button
                                onClick={() =>
                                  removeFormula(unit.id, topic.id, index)
                                }
                                size="sm"
                                variant="ghost"
                  ...
                  <div className="mb-6">
                    ...
                    {topic.content.workedExamples.map((example, index) => (
                      <div
                        key={index}
                        className="bg-green-50 p-4 rounded border border-green-200 mb-4"
                      >
                  ...
                  <div className="mb-6">
                    ...
                    {topic.content.examQuestions.map((question, index) => (
                      <div
                        key={index}
                        className="bg-yellow-50 p-4 rounded border border-yellow-200 mb-4"
                      >
                        ...
                        <div className="text-yellow-900 mb-3 font-medium">
                          {question.question}
                        </div>
