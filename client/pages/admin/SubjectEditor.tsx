...
const mockSubject: Subject = {
  ...
  curriculum: {
    overview:
      "Mathematical Methods provides students with advanced mathematical skills including calculus, functions, probability, and statistics. Students develop mathematical reasoning and problem-solving capabilities essential for STEM fields.",
    learningOutcomes: [
  ...
  topics: [
    {
      ...
      description:
        "Understanding different types of functions, their properties, and transformations",
      learningObjectives: [
    ...
    },
    {
      ...
      description:
        "Introduction to derivatives, differentiation rules, and applications",
      learningObjectives: [
...
export default function SubjectEditor() {
    ...
    for (let i = 0; i < 15; i++) {
      sampleQuestions.push({
        ...
        correctAnswer:
          "The systematic analysis of limit behavior and continuity properties",
        explanation:
          "This question demonstrates understanding of fundamental calculus concepts and their application in mathematical analysis.",
        workingSteps: [
  ...
  const generateContent = async () => {
    ...
    setSubject((prev) => ({
      ...
      contentGeneration: {
        flashcardsGenerated:
          prev.contentGeneration.flashcardsGenerated +
          Math.floor(totalItems * 0.4),
        quizzesGenerated:
          prev.contentGeneration.quizzesGenerated +
          Math.floor(totalItems * 0.33),
        notesGenerated:
          prev.contentGeneration.notesGenerated + Math.floor(totalItems * 0.33),
    ...
    setTimeout(() => {
      ...
      alert(
        `Content generation completed! Generated materials for ${units.length} units with comprehensive coverage.`,
      );
    }, 1000);
  };
      ...
      case "notes":
        return {
          ...
          sections: [
            {
              heading: "Overview",
              content: `Comprehensive overview of ${context}`,
            },
            {
              heading: "Key Concepts",
              content: `Important concepts in ${context}`,
            },
            {
              heading: "Examples",
              content: `Practical examples of ${context}`,
            },
            {
              heading: "Summary",
              content: `Summary of ${context} learning objectives`,
            },
          ],
        };
      default:
  ...
  const deleteQuestion = (questionId: string) => {
    ...
    setSubject((prev) => ({
      ...
      contentGeneration: {
        ...prev.contentGeneration,
        questionsGenerated: Math.max(
          0,
          prev.contentGeneration.questionsGenerated - 1,
        ),
      },
    }));
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                {isEditMode
                  ? "Modify subject details, curriculum, and content"
                  : "Set up a new subject with curriculum and learning materials"}
              </p>
            </div>
          ...
          <div className="space-y-6">
            <Card className="border-sky-blue-200">
              <CardHeader>
                ...
                <CardDescription>
                  Set up the fundamental details for this subject
                </CardDescription>
              </CardHeader>
          ...
          <div className="space-y-6">
            <Card className="border-sky-blue-200">
              <CardHeader>
                ...
                <CardDescription>
                  Define the overall curriculum structure and learning framework
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  ...
                  <p className="text-blue-700 mb-4">
                    Upload your curriculum PDF and let AI automatically extract
                    units, topics, and subtopics to structure your course
                    content.
                  </p>
                    ...
                    <div className="border border-blue-300 rounded-lg p-4 bg-white">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900">
                              {subject.curriculum.curriculumDocument.title}
                            </h4>
                            <div className="flex items-center space-x-4 text-sm text-gray-600">
                              <span>
                                {subject.curriculum.curriculumDocument.fileSize}
                              </span>
                              <span>
                                Uploaded:{" "}
                                {
                      ...
                      {subject.curriculum.curriculumDocument.extractedUnits && (
                        <div className="mt-4 space-y-3">
                          ...
                          {subject.curriculum.curriculumDocument.extractedUnits.map(
                            (unit, unitIndex) => (
                              <div
                                key={unitIndex}
                                ...
                                <div className="flex items-center justify-between mb-3">
                                  <Input
                                    ...
                                    onChange={(e) => {
                                      const newUnits = [
                                        ...subject.curriculum
                                          .curriculumDocument!.extractedUnits!,
                                      ];
                                      newUnits[unitIndex] = {
                                        ...unit,
                                  ...
                                  <Button
                                    ...
                                    onClick={() => {
                                      const newUnits =
                                        subject.curriculum.curriculumDocument!.extractedUnits!.filter(
                                          (_, i) => i !== unitIndex,
                                        );
                                      setSubject((prev) => ({
                                        ...prev,
                                      ...
                                      <div className="flex flex-wrap gap-1 mb-2">
                                        {topic.subtopics.map(
                                          (subtopic, subtopicIndex) => (
                                            <div
                                              key={subtopicIndex}
                                              className="flex items-center space-x-1 bg-white rounded px-2 py-1 border"
                                            >
                                              <Input
                                                value={subtopic}
                                                onChange={(e) => {
                    ...
                    <div className="mt-4 p-4 border border-blue-200 bg-blue-50 rounded-lg">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-blue-700">
                          Processing curriculum document and extracting units
                          and topics...
                        </span>
                      </div>
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Upload exam papers for AI content generation
                    </CardDescription>
                  </div>
                  <div>
                    <input
                        ...
                        <div className="mt-3 pt-3 border-t border-gray-200">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm text-green-700">
                              Content analyzed and ready for AI generation
                            </span>
                          </div>
                        </div>
                      )}
                  ...
                  {subject.examPapers.length === 0 && !isUploading && (
                    <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                      ...
                      <p className="text-gray-600 mb-4">
                        Upload past exam papers to enhance AI content
                        generation.
                      </p>
                    </div>
                  )}
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-sky-blue-200">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    {subject.contentGeneration.flashcardsGenerated}
                  </div>
              ...
              <Card className="border-sky-blue-200">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    {subject.contentGeneration.quizzesGenerated}
                  </div>
              ...
              <Card className="border-sky-blue-200">
                <CardContent className="p-6 text-center">
                  ...
                  <div className="text-2xl font-bold text-gray-900">
                    {subject.contentGeneration.notesGenerated}
                  </div>
                  <div className="text-sm text-gray-600">
            ...
            <Card className="border-sky-blue-200">
              <CardHeader>
                ...
                <CardDescription>
                  Generate comprehensive question bank with 250 multiple choice
                  questions covering all curriculum topics
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="mt-6 bg-green-50 border border-green-200 rounded-lg p-6">
                  ...
                  <p className="text-green-700 mb-4">
                    AI will analyze your curriculum, learning materials, and
                    exam papers to generate 250 comprehensive multiple choice
                    questions per subtopic with:
                  </p>
            ...
            <Card className="border-purple-200">
              <CardHeader>
                ...
                <CardDescription>
                  Create detailed study notes for individual subtopics with
              ...
              <CardContent>
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
                  <h4 className="font-medium text-purple-900 mb-3">
                    Subtopic-Specific Study Notes
                  </h4>
                  <p className="text-purple-700 mb-4">
                    Generate focused study notes for each subtopic with detailed
                    explanations, key concepts, examples, and practice
                    exercises.
                  </p>
            ...
            <Card className="border-indigo-200">
              <CardHeader>
                <CardTitle>
                  Generate Comprehensive Subject Study Notes
                </CardTitle>
                <CardDescription>
                  Create unified study notes covering the entire subject with
              ...
              <CardContent>
                <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-6">
                  <h4 className="font-medium text-indigo-900 mb-3">
                    Complete Subject Study Guide
                  </h4>
                  <p className="text-indigo-700 mb-4">
                    Generate a comprehensive study guide that integrates all
                    units and topics, showing how concepts connect across the
                    subject.
                  </p>
                    ...
                    <div className="mb-4 p-3 bg-white rounded border border-indigo-200">
                      <div className="text-sm text-indigo-600 space-y-1">
                        ...
                        <div>
                          ...
                          {subject.curriculum.curriculumDocument.extractedUnits.reduce(
                        ...
                        <div>
                          ...
                          {subject.curriculum.curriculumDocument.extractedUnits.reduce(
                            (acc, unit) =>
                              ...
                              unit.topics.reduce(
                                (topicAcc, topic) =>
                                  topicAcc + topic.subtopics.length,
                                0,
                              ),
                            0,
                          )}{" "}
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Upload additional learning materials, textbooks,
                ...
                <div className="space-y-4">
                  {subject.subjectMaterials.map((material) => (
                    ...
                    >
                      ...
                      {material.relevantTopics &&
                        material.relevantTopics.length > 0 && (
                          <div className="mt-3 pt-3 border-t border-gray-200">
                            <Label className="text-sm text-gray-600">
                              Relevant Topics:
                            </Label>
                  ...
                  {subject.subjectMaterials.length === 0 &&
                    !isUploadingMaterial && (
                      <div className="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                        ...
                        <p className="text-gray-600 mb-4">
                          Upload textbooks, worksheets, videos, and other
                          learning materials to enhance your subject content.
                        </p>
                        <div className="text-sm text-gray-500">
                          <p>
                            Supported formats: PDF, DOC, DOCX, PPT, PPTX, JPG,
                            PNG, MP4, MOV
                          </p>
                        </div>
                      </div>
