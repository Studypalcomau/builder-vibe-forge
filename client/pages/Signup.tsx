...
export default function Signup() {
  ...
  const handleSocialSignup = (provider: string) => {
    ...
    // In a real app, implement social signup here
  };
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">
            Join thousands of Queensland students achieving academic excellence
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-start">
                <input
                  ...
                  name="terms"
                  type="checkbox"
                  className="h-4 w-4 text-sky-blue-600 focus:ring-sky-blue-500 border-gray-300 rounded mt-0.5"
                  required
                />
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                  I agree to the{" "}
                  <Link to="/terms" className="text-sky-blue-600 hover:text-sky-blue-500">
                    Terms of Service
                  </Link>{" "}
                  and{" "}
                  <Link to="/privacy" className="text-sky-blue-600 hover:text-sky-blue-500">
                    Privacy Policy
                  </Link>
                </label>
              </div>
        ...
        <div className="text-center">
          <p className="text-gray-600">
            ...
            <Link to="/login" className="text-sky-blue-600 hover:text-sky-blue-500 font-medium">
              Sign in
            </Link>
          </p>
        </div>
